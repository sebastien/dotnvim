...
" Macro include directive with path highlighting
syn match   pamlInclude       "^\s*%\(include\|extends\|import\)\s\+.*$" contains=pamlIncludeKeyword
syn match   pamlIncludeKeyword "^\s*%\(include\|extends\|import\)" contained nextgroup=pamlIncludePath
syn match   pamlIncludePath   "\S.*$"                  contained
...
hi def link pamlInclude       Include
hi def link pamlIncludeKeyword Special
hi def link pamlIncludePath    String
